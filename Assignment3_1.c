...
void ReverseElementsInList(PNODE Head)
{
    while (Head != NULL)
    {
        Head->data = ReverseElement(Head->data);
        Head = Head->next;
    }
}
...
int main()
{
    ...
    printf("Number of element are : %d\n",iRet);
     ...
     ReverseElementsInList(First);

    printf("Linked list after reversing elements:\n");
    Display(First);
